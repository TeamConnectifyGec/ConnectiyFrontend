  ...
  const handleServerResponse = async () => {
    try {
      ...
      const response = await axios.post(
         "https://connectify-backend-seven.vercel.app/api/password/forgot-password",{email}
      );

      setAlertMessage(response.data.message );
      setModalVisible(true);

      // after this the user should open the mail and change password
      // as soon as the user closes the alert message navigate to the login page 
